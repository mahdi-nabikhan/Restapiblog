...
class TestAccountAPI:
    ...
    def setup_method(self):
        ...
        self.user_data = {"email": "user@example.com", "password": "StrongPass123!"}
    ...
    def test_jwt_refresh(self):
        ...
        create_response = self.client.post(create_url, self.user_data, format="json")
    ...
    def test_jwt_verify(self):
        ...
        if create_response.status_code == 200:
            ...
            response = self.client.post(verify_url, {"token": access}, format="json")
    ...
    def test_change_password(self):
        ...
        response = self.client.put(
            url,
            {"old_password": "StrongPass123!", "new_password": "NewPassword123!"},
            format="json",
        )
